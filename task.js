...
while (userInput !== "CLOSE") {
  ...
  if (userInput === "TASKS") {
    ...
    while (true) {
      ...
      // Prompts the user to enter a number and stores their response. Also, using \n to create a new line. Finally, subtracting 1 from the user's entry so it matches the index in the tasks array. (NOTE: JavaScript will attempt to convert a string into a number when you try to to subtract from it. Just)
